...
export class DaemonClient {
  ...
  >(message: T) {
    ...
    return registerPendingPromise(
      ...
      () => {
        this.sendMessageToDaemon({ ...message, tx });
      },
  ...
  async requestShutdown(): Promise<void> {
    return this.sendMessageToDaemonViaTx({ type: 'REQUEST_SHUTDOWN' });
  }
  ...
  async getProjectGraphAndSourceMaps(): Promise<{
    ...
    return this.sendMessageToDaemonViaTx({
  ...
  async getAllFileData(): Promise<FileData[]> {
    return this.sendMessageToDaemonViaTx({ type: 'REQUEST_ALL_FILE_DATA' });
  }
  ...
  async registerFileWatcher(
    ...
    const tx = this.getNextTxId('REGISTER_FILE_WATCHER');

    await registerPendingPromise(
      tx,
      this.pendingPromises,
      () => {
        messenger.sendMessage({ type: 'REGISTER_FILE_WATCHER', config, tx });
      },
      getTimeoutErrorMessage('REGISTER_FILE_WATCHER'),
      MAX_MESSAGE_WAIT
    );
  ...
  recordOutputsHash(outputs: string[], hash: string): Promise<any> {
    return this.sendMessageToDaemonViaTx<HandleRecordOutputsHashMessage>({
  ...
  glob(globs: string[], exclude?: string[]): Promise<string[]> {
    return this.sendMessageToDaemonViaTx<HandleGlobMessage>({
      type: 'GLOB',
      globs,
      exclude,
    });
  ...
  getWorkspaceContextFileData(): Promise<FileData[]> {
    return this.sendMessageToDaemonViaTx<HandleContextFileDataMessage>({
  ...
  getWorkspaceFiles(
    ...
    return this.sendMessageToDaemonViaTx<HandleNxWorkspaceFilesMessage>({
  ...
  getFilesInDirectory(dir: string): Promise<string[]> {
    return this.sendMessageToDaemonViaTx<HandleGetFilesInDirectoryMessage>({
  ...
  hashGlob(globs: string[], exclude?: string[]): Promise<string> {
    return this.sendMessageToDaemonViaTx<HandleHashGlobMessage>({
      type: HASH_GLOB,
      globs,
      exclude,
    });
  ...
  getFlakyTasks(hashes: string[]): Promise<string[]> {
    return this.sendMessageToDaemonViaTx<HandleGetFlakyTasks>({
  ...
  async getEstimatedTaskTimings(
    ...
    return this.sendMessageToDaemonViaTx<HandleGetEstimatedTaskTimings>({
  ...
  recordTaskRuns(taskRuns: TaskRun[]): Promise<void> {
    return this.sendMessageToDaemonViaTx<HandleRecordTaskRunsMessage>({
  ...
  getSyncGeneratorChanges(
    ...
    return this.sendMessageToDaemonViaTx<HandleGetSyncGeneratorChangesMessage>({
  ...
  flushSyncGeneratorChangesToDisk(
    ...
    return this.sendMessageToDaemonViaTx<HandleFlushSyncGeneratorChangesToDiskMessage>(
      {
  ...
  getRegisteredSyncGenerators(): Promise<{
    ...
    return this.sendMessageToDaemonViaTx<HandleGetRegisteredSyncGeneratorsMessage>(
      {
  ...
  updateWorkspaceContext(
    ...
    return this.sendMessageToDaemonViaTx<HandleUpdateWorkspaceContextMessage>({
    ...
    try {
      ...
      if (tx) {
        ...
        if (pending) {
          ...
          output.error({
            title: `Received a response with an unknown transaction ID: ${tx}`,
            bodyLines: [
  ...
  async stop(): Promise<void> {
    return this.sendMessageToDaemonViaTx({ type: 'FORCE_SHUTDOWN' })
      .catch((e) => {
        output.error({
          title:
            e?.message ||
